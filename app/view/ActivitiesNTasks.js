...
requires:['Ext.form.FieldSet','Ext.field.Text','radiss.view.EditActivitiesNtaskForm'],
config:{			
...
//	config:{
		...
		iconCls:'favorites',
		store:{
		 fields: ['id', 'workedOn','taskTitle','taskId','description','percent','startDate','endDate','responsibleCompany'],
	        data: [
	           /*
	...
	itemTpl:new Ext.XTemplate('<span>{taskTitle}&nbsp;<br/><font size="2"><b>{description}<br/>Worked On: {workedOn} | {percent}% Completed | Responsible Company: {responsibleCompany}<br/>Start Date: {[values.endDate.format(stdDateFormat)]} <br/> End Date: {[values.startDate.format(stdDateFormat)]} </b></font></span>',
	{
		compiled: true,
